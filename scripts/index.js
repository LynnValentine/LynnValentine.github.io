...
x = setInterval(function () {
  ...
  if (distance > 0) {
    ...
    function init() {
      ...
      box.addEventListener('click', alertToRedirect, false);
    }
    ...
    function alertToRedirect() {
      setInterval(function () {
        if (confirm('Want to see another suprise?')) {
          // Save it!
          window.location.href = '/something-different';
          console.log('Yes');
        } else {
          // Do nothing!
          console.log('No');
